...
import appPreviewImg from '../assets/app-nwl-phone-preview.png'
import logoImg from '../assets/logo.svg'
import usersExampleImg from '../assets/users-example-avatar.png'
  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      <main>
        ...
        <h1 className="mt-14 text-white text-5xl font-bold leading-center">Crie seu próprio bolão da copa e compartilhe entre seus amigos!</h1>

        <div className='mt-10 flex items-center gap-2'>
          <Image src={usersExampleImg} alt="" quality={100} />
          <strong className="text-gray-100 text-xl">
            <strong className="text-ignite-500">+{ props.userCount }</strong> pessoas já estão usando
          </strong>
        </div>
      ...
      <Image src={appPreviewImg} alt="Preview do aplicativo em smartphones." quality={100} />
    </div>
  )
}
